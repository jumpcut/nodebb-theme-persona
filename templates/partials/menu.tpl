			...
			<div class="absolute-nav">
                 <li><a href="https://app.jumpcut.com/" title="courses">Courses</a></li>
                 <li><a href="/categories" title="forum">Community</a></li>
         </div>
         <div id="nav-dropdown" class="navbar-collapse collapse navbar-ex1-collapse">
				...
				<ul id="logged-in-menu" class="nav navbar-nav navbar-right">
					...
					<li id="user_label" class="dropdown">
						...
						<ul id="user-control-list" component="header/usercontrol" class="dropdown-menu" aria-labelledby="user_dropdown">
							...
							<li role="presentation" class="divider"></li>
							<li>
								<a href="https://app.jumpcut.com/account/settings">
